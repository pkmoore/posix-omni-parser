...
class TestDir(object):
    ...
    def test_chdir(self):
        ...
        assert (
            bad_chdir_call.args[0].value
            == "/home/almazhan/Desktop/res_tandon/posix-omni-parser/testbins1"
        )
...
class TestWrite(object):
    def test_write(self):
        ...
        assert (
            write_call.args[1].value
            == '"crashsimlang  get-pip.py  local  posix-omni-parser  test\\n"'
        )
