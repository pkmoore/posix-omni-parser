...
class Parser():
  ...
  def __init__(self, trace_path):
    ...
    # get the HOME environment variable. Normally the environment variable
    # appears as arguments of the execve system call. execve syscall should be
    # the first system call in a trace. The HOME environment variable is useful
    # as general information about the trace and in particular when a file
    # bundle needs to be generated. To generate a file bundle all the files
    # referenced in the trace must be located and included in the bundle. The
    # location of these files is in respect to the HOME variable if one is
    # found, otherwise the home directory is assumed to be the current directory
    # (pwd)
