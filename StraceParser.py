...
class StraceParser(Parser.Parser):
  """
  <Purpose>
  ...
  def __init__(self, trace_path):
    ...
    super(StraceParser, self).__init__(trace_path)
  ...
  def _parse_line(self, line, unfinished_syscalls):
    ...
    <Arguments>
      ...
      unfinished_syscalls:
        This is a list of all the unfinished system calls previously met. A 
  ...
  def _parse_args(self, args_string):
    ...
    # with a comma "," with no arguments following this. Let's remove the comma
    # as well.
    ...
    args_list = _merge_quote_args(args_string.split(", "))
...
def _merge_quote_args(args_list):
  """
  <Purpose>
